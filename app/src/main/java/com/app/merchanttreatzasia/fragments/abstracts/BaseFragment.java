package com.app.merchanttreatzasia.fragments.abstracts;
...
import com.app.merchanttreatzasia.helpers.GPSTracker;
import com.app.merchanttreatzasia.helpers.ServiceHelper;
import com.app.merchanttreatzasia.helpers.UIHelper;
import com.app.merchanttreatzasia.interfaces.LoadingListener;
...
import static com.app.merchanttreatzasia.global.WebServiceConstants.Local_SERVICE_URL;
...
public abstract class BaseFragment extends Fragment implements webServiceResponseLisener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (withoutHeaderWebService == null) {
            withoutHeaderWebService = WebServiceFactory.getWebServiceInstanceWithDefaultInterceptor(getDockActivity(), WebServiceConstants.Local_SERVICE_URL);
        }

        if (webService == null) {
            webService = WebServiceFactory.getWebServiceInstanceWithCustomInterceptor(getDockActivity(), Local_SERVICE_URL);
        }
