package com.app.merchanttreatzasia.ui.dialogs;
...
import com.app.merchanttreatzasia.fragments.MapControllerDialog;
import com.app.merchanttreatzasia.fragments.MapControllerFragment;
...
public class DialogFactory {
	...
	public static Dialog createMessageDialog( Activity activity,
			...
			CharSequence message, String titleId,int resourceID ) {
		AlertDialog.Builder builder = new AlertDialog.Builder( activity );
